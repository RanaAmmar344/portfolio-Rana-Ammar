...
/>
       ...
       variants={containerVariants} 
        ...
        className='flex flex-col items-center lg:items-start mt-10'>
          ...
          <motion.a variants={childVariants} href='/Rana_Ammar_Mushtaq.pdf' target='_blank' 
          rel='noopener norefeerer'
          download
          className='bg-white rounded-full font-semibold p-4 text-sm text-stone-800 mb-10 hover:bg-gray-800  hover:text-white'
          >
            Download Resume
          </motion.a>
